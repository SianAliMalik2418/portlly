...
export const GuessInput = ({ input, toast, shake, won, onInputChange, onSubmit, onHint }: GuessInputProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        <motion.button
          whileTap={{ transform: "scale(0.88) rotate(-10deg)" }}
          transition={{ type: "spring", stiffness: 500, damping: 20 }}
          className="grid h-[3.125rem] w-[3.125rem] shrink-0 place-items-center rounded-full border border-border bg-card text-[1.125rem]"
          onClick={onHint}
          disabled={won}

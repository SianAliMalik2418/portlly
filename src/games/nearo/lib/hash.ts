...
const HASH_INITIAL: Array<number> = [
...
const toHexWord = (value: number) => value.toString(16).padStart(8, "0")
...
export const hashGuess = (guess: string) => sha256Hex(normalizeGuess(guess))
